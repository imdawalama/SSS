...
<section class="category">
   ...
   <a href="category.php?category=Acoustic-guitar" class="swiper-slide slide">
   ...
   <a href="category.php?category=Ukulele" class="swiper-slide slide">
      <img src="images/icon-03.png" alt="">
      <h3>Ukulele</h3>
   </a>

   <a href="category.php?category=Drum" class="swiper-slide slide">
   ...
   <a href="category.php?category=tradional" class="swiper-slide slide">
      <img src="images/icon-06.png" alt="">
      <h3>Tradional instro</h3>
   </a>
   ...
   <a href="category.php?category=Amp" class="swiper-slide slide">
